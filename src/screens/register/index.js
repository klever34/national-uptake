...
import {View, Modal, TouchableOpacity, BackHandler} from 'react-native';
...
class Register extends Component {
  ...
  getToken = async () => {
    try {
      ...
      const email = await this.props.route.params.email;
      this.setState({email});
    } catch (error) {
          ...
          <View>
            ...
            <View>
              <Item
                regular
                rounded
                style={[styles.inputStyle, {marginVertical: 10}]}>
                <Input
