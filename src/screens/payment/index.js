...
class Payment extends Component {
  ...
  async chargeCard() {
    if (this.state.cards.length >= 2) {
      alert("Sorry, you can't save more than two cards");
      return;
    }
    ...
    try {
      ...
      this.addRequest(response.data.data);
    } catch (error) {
      console.log(error.response);
    }
  }
  ...
  async addRequest(item) {
    ...
    axios({
      ...
      data: {
        ...
        authorizationCode: item.authorization.authorization_code,
        bank: item.authorization.bank,
        last4: item.authorization.last4,
        default: this.state.cards.length === 0 ? true : false,
      },
      headers: {
        Authorization: `Bearer ${token}`,
      },
              ...
              <View
                ...
                <View style={{marginTop: 30, alignSelf: 'center'}}>
                  ...
                  <Text
                    ...
                    A three-digit code that you can find on the back of your
                    card
                  </Text>
                  <View
                    style={{
